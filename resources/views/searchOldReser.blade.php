                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-outline-secondary"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#detailsModal{{$res->id}}">
                                ...
                                <div id="reservationContent{{$res->id}}" class="modal-reservation-details">
                                    ...
                                    <ul class="list-group list-group-flush mb-4">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between">
                                            ...
                                            <span>من {{ $res->start }} إلى {{ $res->end }} (<span
                                                    class="text-info">{{ $duration }}</span> ليالي)</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between">
                                                    ...
                                                    <div class="card shadow-sm border-2 {{ $colorClass }}">
                                                        ...
                                                        <ul class="list-group list-group-flush">
                                                            ...
                                                            <li
                                                                ...
                                                                <span
                                                                    class="text-success font-weight-bold">{{ number_format($detail->price, 2) }}
                                                                    ريال</span>
                                                            </li>
                                                        </ul>
                                                    </div>
